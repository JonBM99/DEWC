...
public class ProductService {
    ...
    private void loadProducts(){
        ...
        this.products.add(new Product(0, "Camisa Túnica de Popelín de Manga Larga Athletic",
        ...
        this.products.add(new Product(1, "Chaqueta Cortavientos Plegable Mujer",
"Esta chaqueta impermeable es totalmente plegable y cuenta con un bolsillo frontal tipo canguro, encuadernación en el dobladillo y las mangas, y un cordón elástico ajustable en el dobladillo inferior para mantener fuera los elementos",
        ...
        this.products.add(new Product(2, "Camisetas Henley de Manga Corta",
        ...
        this.products.add(new Product(3, "Pantalón chino",
        ...
        this.products.add(new Product(4, "Polo de Rendimiento Activo",
        ...
        this.products.add(new Product(5, "Sudadera Hombre",
        ...
        this.products.add(new Product(6, "Pantalón de Pierna Ancha con cordón de Mezcla de Lino",
        ...
        this.products.add(new Product(7, "Hombre Camisa de franela a cuadros de manga larga",
        ...
        this.products.add(new Product(8, "Camisetas de Manga Corta Niños, Pack de 5",
                "Tejido de punto ligero, cómodo y suave.",
                13.9,"niño","http://peticiones.online/images/products/image10.png",
                true));

        this.products.add(new Product(9, "Camiseta sin Mangas",
                "Tejido de punto ligero, cómodo y suave.",
                22.1,"niño","http://peticiones.online/images/products/image16.png",
                false));

        this.products.add(new Product(10, "Suéter Ligero con Frente Abierto Mujer",
                "Corte estrecho y cómodo que permite el movimiento.",
                18.9,"mujer","http://peticiones.online/images/products/image02.png",
                false));

        this.products.add(new Product(11, "Hombre Camisetas interiores de cuello a la caja, Pack de 6",
                "Tejido de punto ligero, cómodo y suave. ",
                23.99,"hombre","http://peticiones.online/images/products/image01.png",
                true));

        this.products.add(new Product(12, "Polo de Golf de Secado rápido de Ajuste Regular Hombre",
        ...
        this.products.add(new Product(13, "Saco de Dormir de Microforro Polar Unisex bebé, Pack de 2",
        ...
        this.products.add(new Product(14, "Vestido Cruzado con Manga Casquillo",
        ...
        this.products.add(new Product(15, "Camisa de Manga Larga de Ajuste clásico",
        ...
        this.products.add(new Product(16, "Camisa de Senderismo de Manga Corta",
