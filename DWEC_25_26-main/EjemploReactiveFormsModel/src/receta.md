...
2 - Creamos un atributo dentro de la etiqueta form que se llama formGroup que contendrá el nombre del formulario, crear propiedad en el ts e iniciar en el constructor.
